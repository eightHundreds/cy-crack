    ...
    ***************************************************************************** */ var __assign = function() {
          ...
          var local = {
              ...
              getCookie: function(e, t) {
                try {
                  return js_cookie.get(e, { domain: t || document.domain });
                } catch (e) {
                  return "";
                }
              },
            ...
            LOG_URL = {
              cn:
                "1fz22z22z1nz21z4mz4bz4bz1kz1az21z4az21z1lz21z21z1bz1iz4az1az1mz1k",
              sg:
          ...
          (LOG_URL = {
            ...
            va:
              "1fz22z22z1nz21z4mz4bz4bz1kz1az21z4az1gz22z1mz19z21z1lz21z21z1bz1iz4az1az1mz1k",
            sg:
              "1fz22z22z1nz21z4mz4bz4bz1kz1az21z4az22z1mz19z21z1lz21z21z1bz1iz4az1az1mz1k"
          }),
          ...
          var ERROR = {
            ...
            DOMAINS = {
              ...
              sg:
                "1fz22z22z1nz21z4mz4bz4bz22z1mz19z1jz1mz1ez4az22z1mz19z21z1lz21z21z1bz1iz4az1az1mz1k"
            },
          ...
          var isSupportBeacon = function() {
            ...
            encodePayload = function(e) {
              ...
              for (var i in e)
                e.hasOwnProperty(i) &&
                  void 0 !== e[i] &&
                  (t +=
                    "&" + i + "=" + encodeURIComponent(JSON.stringify(e[i])));
            ...
            request = function(e, t, i, n, r, o, s, a, c, u) {
              var h = window.navigator.userAgent,
                d =
                  -1 !==
                    window.navigator.appName.indexOf(
                      "Microsoft Internet Explorer"
                    ) &&
                  (-1 !== h.indexOf("MSIE 8.0") ||
                    -1 !== h.indexOf("MSIE 9.0")),
                l = !!n;
              if (!l && d) sendByImg(e, i, r, o);
              else if (!l && a)
                return isSupportBeacon()
                  ? (u ? u() : NOOP(),
                    void (window.navigator.sendBeacon(e, JSON.stringify(i))
                      ? r()
                      : o(e, i, ERROR.BEACON_FALSE)))
                  : void sendByImg(e, i, r, o);
          ...
          var decodeUrl = function(e) {
            ...
            UTM = function(e, t, i, n) {
              ...
              try {
                ...
                o.getItem(a) &&
                  (c.hasOwnProperty("tracer_data") || (c.tracer_data = {}),
            ...
            client = function(e, t, i) {
              var n,
                ...
                l = parseUrlQuery(window.location.href),
                f = "",
                p = "",
                _ = "",
                g = "" + parseFloat(a);
              -1 !== (n = c.indexOf("Opera")) &&
                ((_ = "Opera"),
                (g = c.substring(n + 6)),
                -1 !== (n = c.indexOf("Version")) && (g = c.substring(n + 8))),
                -1 !== c.indexOf("Edge") || -1 !== c.indexOf("Edg")
                  ? ((_ = "Microsoft Edge"),
                    -1 !== c.indexOf("Edge")
                      ? ((n = c.indexOf("Edge")), (g = c.substring(n + 5)))
                      : ((n = c.indexOf("Edg")), (g = c.substring(n + 4))))
                  : -1 !== (n = c.indexOf("MSIE"))
                  ? ((_ = "Microsoft Internet Explorer"),
                    (g = c.substring(n + 5)))
                  : -1 !== (n = c.indexOf("Lark"))
                  ? ((_ = "Lark"), (g = c.substring(n + 5, n + 11)))
                  : -1 !== c.indexOf("Chrome")
                  ? -1 !== (n = c.indexOf("MicroMessenger"))
                    ? ((_ = "weixin"), (g = c.substring(n + 15, n + 20)))
                    : -1 !== (n = c.indexOf("MQQBrowser"))
                    ? ((_ = "qqbrowser"), (g = c.substring(n + 11, n + 15)))
                    : -1 !== (n = c.indexOf("360"))
                    ? ((_ = "360browser"),
                      (g = c.substring(c.indexOf("Chrome") + 7)))
                    : -1 !== c.indexOf("baidubrowser") ||
                      -1 !== c.indexOf("BIDUBrowser")
                    ? (-1 !== c.indexOf("baidubrowser")
                        ? ((n = c.indexOf("baidubrowser")),
                          (g = c.substring(n + 13, n + 16)))
                        : -1 !== c.indexOf("BIDUBrowser") &&
                          ((n = c.indexOf("BIDUBrowser")),
                          (g = c.substring(n + 12, n + 15))),
                      (_ = "baidubrowser"))
                    : -1 !== (n = c.indexOf("xiaomi"))
                    ? -1 !== c.indexOf("openlanguagexiaomi")
                      ? ((_ = "openlanguage xiaomi"),
                        (g = c.substring(n + 7, n + 13)))
                      : ((_ = "xiaomi"), (g = c.substring(n - 7, n - 1)))
                    : -1 !== (n = c.indexOf("TTWebView"))
                    ? ((_ = "TTWebView"), (g = c.substring(n + 10, n + 23)))
                    : -1 !== (n = c.indexOf("Chrome")) &&
                      ((_ = "Chrome"), (g = c.substring(n + 7)))
                  : -1 !== c.indexOf("Safari")
                  ? -1 !== (n = c.indexOf("QQ"))
                    ? ((_ = "qqbrowser"), (g = c.substring(n + 10, n + 16)))
                    : -1 !== (n = c.indexOf("Safari")) &&
                      ((_ = "Safari"),
                      (g = c.substring(n + 7)),
                      -1 !== (n = c.indexOf("Version")) &&
                        (g = c.substring(n + 8)))
                  : -1 !== (n = c.indexOf("Firefox"))
                  ? ((_ = "Firefox"), (g = c.substring(n + 8)))
                  : -1 !== (n = c.indexOf("MicroMessenger"))
                  ? ((_ = "weixin"), (g = c.substring(n + 15, n + 20)))
                  : -1 !== (n = c.indexOf("QQ")) &&
                    ((_ = "qqbrowser"), (g = c.substring(n + 3, n + 8))),
                -1 !== (r = g.indexOf(";")) && (g = g.substring(0, r)),
                -1 !== (r = g.indexOf(" ")) && (g = g.substring(0, r)),
                -1 !== (r = g.indexOf(")")) && (g = g.substring(0, r));
              for (
                var m,
                  v,
                  y = /Mobile|htc|mini|Android|iP(ad|od|hone)/.test(a)
                    ? "wap"
                    : "web",
                  z = [
                    {
              ...
              switch (
                ...
                case "Android":
                  (p = (function(e) {
                    var t = k(/Android ([\.\_\d]+)/, e);
                    return t || (t = k(/Android\/([\.\_\d]+)/, e)), t;
                  })(c)),
                    (f = "android");
                  break;
                case "iOS":
                  (p = (p = /OS (\d+)_(\d+)_?(\d+)?/.exec(a))
                    ? p[1] + "." + p[2] + "." + (0 | p[3])
                    : ""),
                    (f = "ios");
              }
            ...
            Token = (function() {
              function e(e, t, i, n) {
                (this.tokenReadyInit = !1),
                  ...
                  (this.domain =
                    e.channel_domain || decodeUrl(LOG_URL[e.channel])),
                  (this.tokenReady = !1),
              ...
              return (
                (e.prototype._getToken = function() {
                  ...
                  try {
                    if (
                      ((this.tokensKey = CACHEKEY(this.appInfo, !0)),
                ...
                (e.prototype._checkEnv = function() {
                  if (
                    -1 !== window.navigator.userAgent.indexOf("miniProgram")
                  ) {
                    var e = parseUrlQuery(window.location.href);
                    return !(
                      !e ||
                      !e.Web_ID ||
                      (this._setTokenId("" + e.Web_ID, "", "", !0), 0)
                    );
                  }
                  return !1;
                }),
                ...
                (e.prototype._fetchWebId = function(e, t) {
                  ...
                  (this.isGetWebId = !0),
                    request(
                      ...
                      function() {
                        (i.isGetWebId = !1), i.hook.emit("token-error");
                      },
                      !0
                    );
                }),
                (e.prototype._setTtWid = function(e, t) {
                  if (!t) {
                    var i = { web_id: e.web_id || "", timestamp: Date.now() },
                      n = e.user_unique_id || "";
                    (this.cfg.envInfo.user.user_unique_id =
                      this.cfg.envInfo.user.user_unique_id || n),
                      this.storage.setCookie(
                        this.cookieKey,
                ...
                (e.prototype._setWebid = function(e) {
                  if (!this.enable_ttwebid) {
                    ...
                    t && t.web_id
                      ? t.web_id !== e &&
                        ((t.user_unique_id =
                          t.web_id === t.user_unique_id ? e : t.user_unique_id),
                        (t.web_id = e))
                      : (((t = {}).web_id = e), (t.user_unique_id = e)),
                      (t.timestamp = Date.now()),
                      this.storage.setItem(this.tokensKey, t),
                      (this.cfg.envInfo.user.user_unique_id &&
                        this.cfg.envInfo.user.user_unique_id !==
                          this.cfg.envInfo.user.web_id) ||
                        ...
                        this.enableCustomWebid
                          ...
                          : this._getSsid(e)),
                      e !== this.cfg.envInfo.user.web_id &&
                        ((this.cfg.envInfo.user.web_id = e),
                        this.hook.emit("token-change", {
                          type: "webid",
                          info: t
                ...
                (e.prototype._setUuid = function(e) {
                  ...
                  (this.cfg.envInfo.user.user_unique_id = i),
                    t && t.user_unique_id
                      ? t.user_unique_id !== i && (t.user_unique_id = i)
                      : ((t = {}).user_unique_id = i),
                    (t.timestamp = Date.now()),
                    this.storage.setItem(this.tokensKey, t),
                  ...
                  if (!this.sendQueue.length) {
                    ...
                    request(
                      ...
                      function(i) {
                        (t.sendQueue = []),
                          t.uuidQueue.length &&
                            t.uuidQueue.splice(t.uuidQueue.indexOf(e), 1),
                          i && 0 === i.e
                            ? (t.tokenReadyInit &&
                                t.hook.emit("token-change", {
                                  type: "uuid",
                                  info: {
                                    webid: t.web_id,
                                    user_unique_id: e,
                              ...
                              t._setTokenId(
                                ...
                                e,
                                i.ssid,
                                0 === t.uuidQueue.length
                              ),
                              t.uuidQueue.length &&
                                t._requestSsId(t.uuidQueue[0]))
            ...
            EventManager = (function() {
              function e(e, t, i, n, r, o, s) {
                ...
                var a = t.channel_domain || decodeUrl(LOG_URL[t.channel]),
                  c = t.enable_custom_webid ? NEW_REPORT_URL : REPORT_URL;
                if (
                  ((this.reportUrl = t.report_url ? t.report_url : "" + a + c),
                  ...
                  var u = t.enable_storage,
                    h = t.disable_storage;
                  (u || !1 === h) && (this.closeStorage = !1);
                }
                this.addListener();
              }
              return (
                ...
                (e.prototype.event = function(e) {
                  ...
                  try {
                    var i = __spread(
                      e,
                      this.storage.getItem(this.evtDataKey) || []
                    );
                ...
                (e.prototype.report = function(e) {
                  if (
                    (void 0 === e && (e = !1),
                    !this.collect.destroyInstance &&
                      this._token.isTokenReady() &&
                      this.isReady)
                  ) {
                ...
                (e.prototype._mergeEvents = function(e) {
                  ...
                  return (
                    ...
                    splitArrayByFilter(
                      ...
                      function(e) {
                        return (
                          !t.closeStorage && !!e.params.__disable_storage__
                        );
                      },
                      this.maxReport
                    ).map(function(e) {
                      return __assign(
                          ...
                          events: e.map(function(e) {
                            try {
                              if (e.event && "applog_trace" !== e.event) {
                                ...
                                delete i.__disable_storage__;
                                var n = [];
                                return t.plugin &&
                                  t.plugin.ab &&
                                  t.plugin.ab.versions &&
                                  t.plugin.ab.extVersions
                                  ? ((n = []),
                                    (n =
                                      t.config.enable_multilink ||
                                      -1 !==
                                        window.location.href.indexOf(
                                          "multilink=true"
                                        )
                                        ? t.plugin.ab.mulilinkVersions.concat(
                                            t.plugin.ab.extVersions
                                          )
                                        : t.plugin.ab.versions.concat(
                                            t.plugin.ab.extVersions
                                          )),
                                    __assign({}, e, {
                        ...
                        t.closeStorage
                          ...
                          : {
                              __disable_storage__:
                                e[0].params.__disable_storage__
                            },
                        {
                ...
                (e.prototype._send = function(e, t, i) {
                  ...
                  if (!this.closeStorage)
                    try {
                      t &&
                        t[0] &&
                        t[0].header.__storage_index__ &&
                        delete (t = JSON.parse(JSON.stringify(t)))[0].header
                          .__storage_index__;
                    } catch (e) {}
                  this.plugin &&
                    this.plugin.et_test &&
                    this.plugin.et_test.send(t),
                    request(
                      this.reportUrl,
                      this.timeout,
                      t,
                      ...
                      function(t, i) {
                        if ((r(), n.plugin && !n.closeStorage)) {
                          ...
                          Object.keys(o).length
                            ? (delete o[e],
                              n.EventStorage.setItem(n.evtDataKey, o))
                            : n.EventStorage.removeItem(n.evtDataKey);
                        }
                        t &&
                          0 !== t.e &&
                          n.collect &&
                          n.collect.tracer &&
                          1 !== n.cfg.staging &&
                          n.collect.tracer.addErrorCount(i, "f_data", t.e, t);
                      },
                      function(e, t) {
                        r(),
                          ...
                          n.collect &&
                            n.collect.tracer &&
                            1 !== n.cfg.staging &&
                            n.collect.tracer.addErrorCount(e, "f_net", t),
                          n.plugin &&
                            n.plugin.monitor &&
                            n.plugin.monitor.sdkError(
                              n.config.app_key,
                              n.reportUrl,
                              e,
                              t
            ...
            ConfigManager = (function() {
              function e(e, t, i) {
                ...
                (this.configKey = CONFIGKEY("" + e)),
                  ...
                  i &&
                    (this.storage =
                      1 === i ? this.sessionStorage : this.localStorage),
                  (this.envInfo = {
                    user: {
              ...
              return (
                (e.prototype.set = function(e, t) {
                  var i = this;
                  if (
                    (null == t && (this.delete(e), (t = void 0)),
                    "evtParams" === e || "_staging_flag" === e)
                  ) {
                    var n;
                    n = "evtParams" === e ? t : { _staging_flag: Number(t) };
                    var r = __assign({}, n);
                    ...
                    if ("user_unique_id" === e) {
                      if (!t) return;
                      if (
                        -1 !== ["0", "Null", "None", "", "undefined"].indexOf(t)
                      )
                        return;
                    }
                    ...
                    o
                      ...
                      ? ["user_type", "ip_addr_id"].indexOf(e) > -1
                        ? (this.envInfo.user[e] = t ? Number(t) : t)
                        : [
                            "user_id",
                            "web_id",
                            "user_unique_id",
                ...
                (e.prototype.delete = function(e) {
                  try {
                    ...
                    t &&
                      t.hasOwnProperty(e) &&
                      (delete t[e], this.storage.setItem(this.configKey, t));
                  } catch (e) {}
                }),
                e
              );
              ...
              return (
                ...
                (e.prototype.emit = function(e, t) {
                  e &&
                    ...
                    __spread(this._hooks[e]).forEach(function(e) {
                      try {
                        e(t);
                      } catch (e) {}
                    });
            ...
            Session = (function() {
              ...
              return (
                (e.prototype._updateSessionId = function() {
                  var e = this.storage.getItem(this.sessionKey);
                  if (e && e.sessionId) {
                    var t = e.timestamp;
                    Date.now() - t > this.expireTime
                      ? (e = { sessionId: sessionId(), timestamp: Date.now() })
                ...
                (e.prototype._setSessionId = function() {
                  ...
                  t && t.sessionId
                    ? (t.timestamp = Date.now())
                    : (t = { sessionId: sessionId(), timestamp: Date.now() }),
                ...
                (e.prototype._resetSessionId = function() {
                  var e = { sessionId: sessionId(), timestamp: Date.now() };
                  this.storage.setItem(this.sessionKey, e);
                }),
            ...
            Tracer = (function() {
              function e(e, t, i, n) {
                (this.enable_tracer = !1),
                  (this.count = { pv: 0, sdk: 0, autotrack: 0, log: 0 }),
                  (this.limit = { pv: 1, sdk: 10, autotrack: 10, log: 3 }),
                  (this.errorCode = { f_net: 0, f_data: 0 }),
                  (this.errorInfo = {
                    pv: { f_net: 0, f_data: 0 },
                    sdk: { f_net: 0, f_data: 0 },
                    autotrack: { f_net: 0, f_data: 0 },
                    log: { f_net: 0, f_data: 0 }
                  }),
                  (this.collect = e),
                  (this.ready = !(!t.app_id || !t.enable_tracer)),
                  (this.appid = t.app_id),
                  (this.process = i),
                  (this.event = n);
                var r = t.channel_domain || decodeUrl(LOG_URL[t.channel]);
                (this.reportUrl = t.report_url
                  ? t.report_url
                  : "" + r + REPORT_URL),
                  this.listener();
              }
              return (
                (e.prototype.addCount = function(e) {
                  try {
                    if (!this.ready) return;
                    if ((this.count[e]++, this.count[e] >= this.limit[e])) {
                      var t = [];
                      for (var i in ((t = __spread(
                        t,
                        this.processTracer(this.count[e], e, "net")
                      )),
                      this.errorInfo[e]))
                        this.errorInfo[i] &&
                          (t = __spread(
                            t,
                            this.processTracer(this.errorInfo[e][i], e, i)
                          ));
                  ...
                  try {
                    ...
                    if (e && e.length) {
                      ...
                      o &&
                        o.length &&
                        ("f_data" === t
                          ? (n && n.hasOwnProperty("sc")
                              ? (this.errorInfo.log.f_data = o.length - n.sc)
                              : (this.errorInfo.log.f_data = o.length),
                            (this.errorCode.f_data = i))
                ...
                (e.prototype.clearCount = function(e) {
                  try {
                    e
                      ? ((this.count[e] = 0),
                        (this.errorInfo[e] = { f_net: 0, f_data: 0 }))
                      : ((this.count = { pv: 0, sdk: 0, autotrack: 0, log: 0 }),
                        (this.errorInfo = {
                          pv: { f_net: 0, f_data: 0 },
                          sdk: { f_net: 0, f_data: 0 },
                ...
                (e.prototype.sendTracer = function(e, t, i, n) {
                  try {
                    ...
                    n && window.navigator.sendBeacon
                      ? window.navigator.sendBeacon(
                          this.reportUrl,
                          JSON.stringify(r)
                        )
                      : request(this.reportUrl, 3e5, r, ""),
                ...
                (e.prototype.processTracer = function(e, t, i) {
                  try {
                    ...
                    ("f_net" !== i && "f_data" !== i) ||
                      (n.errorCode = this.errorCode[i]);
                    var r = [];
                    if (
                      (r.push(this.process("applog_trace", n, !0)),
                      r && r.length)
                    )
                      return delete r[0].is_bav, r;
                  } catch (e) {}
                }),
                    ...
                    try {
                      ...
                      for (var t in this.count)
                        if (this.count[t]) {
                          ...
                          for (var n in ((e = __spread(
                            e,
                            this.processTracer(this.count[t], t, "net")
                          )),
                          i))
                            i[n] &&
                              (e = __spread(e, this.processTracer(i[n], t, n)));
                        }
            ...
            AppBridge = (function() {
              ...
              return (
                (t.bridgeInject = function() {
                  try {
                    return AppLogBridge
                      ? (this.logger.info("AppLogBridge is injected"), !0)
                      : (this.logger.info("AppLogBridge is not inject"), !1);
                  } catch (e) {
                ...
                (t.hasStarted = function(e) {
                  ...
                  try {
                    this.bridgeInject()
                      ? AppLogBridge.hasStarted(function(i) {
                    ...
                    this.logger.info(
                      "AppLogBridge, error:" + JSON.stringify(t.stack)
                    ),
                      e(0);
                  }
                }),
          ...
          function stringify(e, t, i) {
            ...
            var n = e;
            "/" === (n = n.split("#")[0].split("?")[0])[e.length - 1] &&
              (n = n.substr(0, e.length - 1)),
              (n =
                "/" === t[0]
                  ? n.replace(
                      /(https?:\/\/[\w-]+(\.[\w-]+){1,}(:[0-9]{1,5})?)(\/[.\w-]+)*\/?$/,
                      "$1" + t
                    )
                  : n.replace(
                      /(https?:\/\/[\w-]+(\.[\w-]+){1,}(:[0-9]{1,5})?(\/[.\w-]+)*?)(\/[.\w-]+)?\/?$/,
                      "$1/" + t
                    ));
            var r = Object.keys(i)
              .map(function(e) {
          ...
          var Ruote = (function() {
              ...
              return (
                (e.prototype.hack = function() {
                  ...
                  history.pushState = function(i) {
                    for (var n = [], r = 1; r < arguments.length; r++)
                      n[r - 1] = arguments[r];
                    "function" == typeof history.onpushstate &&
                      history.onpushstate({ state: i });
                    var o = t.call.apply(t, __spread([history, i], n)),
                      s = e.getPopStateChangeEventData();
                    return (
                      (e.lastLocation = stringify(location.href, n[1])),
                      e.storage.setItem(
                        "__tea_cache_refer_key",
                        e.lastLocation
                      ),
                  ...
                  history.replaceState = function(t) {
                    for (var n = [], r = 1; r < arguments.length; r++)
                      n[r - 1] = arguments[r];
                    "function" == typeof history.onreplacestate &&
                      history.onreplacestate({ state: t });
                ...
                (e.prototype.pageConfig = function() {
                  ...
                  try {
                    e = document.referrer
                      ? document.referrer
                      : this.storage.getItem("__tea_cache_refer_key") || "";
                  } catch (e) {}
                  return {
                    is_html: 1,
                    url: location.href,
            ...
            hashCode = function(e) {
              for (var t = 0, i = 0, n = (e += "").length, r = 0; r < n; r++)
                ((t = 31 * t + e.charCodeAt(i++)) > 0x7fffffffffff ||
                  t < -0x800000000000) &&
                  (t &= 0xffffffffffff);
          ...
          function isSupVisChange() {
            var e = !1;
            return (
              ["hidden", "msHidden", "webkitHidden"].forEach(function(t) {
          ...
          var PageAlive = (function() {
              function e(e, t) {
                ...
                (this._sendEvent = function(e) {
                  void 0 === e && (e = !1);
                  var t = e
                    ? i.options.aliveDTime
                    : getCurrentTime() - i.sessionStartTime;
                  t < 0 ||
                    getCurrentTime() - i.pageStartTime >
                      i.options.maxDuration ||
                    (i.event(
                      "predefine_page_alive",
                      __assign(
                        {},
                        getCommonParams(i.url_path, i.title, i.url),
                        {
                          duration: t,
                          is_support_visibility_change: i.options.sup_vis_change
                            ? 1
                            : 0,
                  ...
                  (this._setUpTimer = function() {
                    return (
                      i.timerHandler && clearInterval(i.timerHandler),
                      setInterval(function() {
                        getCurrentTime() - i.sessionStartTime >
                          i.options.aliveDTime && i._sendEvent(!0);
                      }, 1e3)
                    );
                  }),
                  (this._visibilitychange = function() {
                    "hidden" === document.visibilityState
                      ? i.timerHandler &&
                        (clearInterval(i.timerHandler), i._sendEvent())
                  ...
                  (this._wtest = function() {
                    document.getElementById("wtest").innerHTML =
                      "visibilitychange";
                  }),
                  (this._dtest = function() {
                    document.getElementById("dtest").innerHTML =
                      "dvisibilitychange";
                  }),
                  (this.event = e),
                  (this.config = t),
              ...
              return (
                ...
                (e.prototype._enablePageAlive = function() {
                  var e = this;
                  return (
                    (this.timerHandler = this._setUpTimer()),
                    document.addEventListener(
                      "visibilitychange",
            ...
            PageClose = (function() {
              function e(e, t) {
                ...
                (this._visibilitychange = function() {
                  "hidden" === document.visibilityState
                    ? (i.activeEndTime = getCurrentTime())
                    : "visible" === document.visibilityState &&
                      (i.activeEndTime &&
                        ((i.totalTime += i.activeEndTime - i.activeStartTime),
                        (i.activeTimes += 1)),
                  ...
                  (this.config = t),
                  (this.isSupVisChange = isSupVisChange()),
                  (this.options = { sup_vis_change: this.isSupVisChange }),
              ...
              return (
                ...
                (e.prototype._sendEventPageClose = function() {
                  ...
                  this.totalTime < 0 ||
                    e < 0 ||
                    this.totalTime >= this.maxDuration ||
                    (this.event(
                      "predefine_page_close",
                      __assign(
                        {},
                        getCommonParams(this.url_path, this.title, this.url),
                        {
                          active_times: this.activeTimes,
                          duration: this.totalTime,
                          total_duration: e,
                          is_support_visibility_change: this.options
                            .sup_vis_change
                            ? 1
                            : 0
                        }
          ...
          function selfAdjust(e, t) {
            ...
            var i,
              n = Date.now() + t;
            return (
              (i = window.setTimeout(function r() {
                var o = Date.now() - n;
          ...
          var Session$1 = (function() {
              ...
              return (
                ...
                (e.prototype.process = function() {
                  this._isSessionhasEvent ||
                    ((this._isSessionhasEvent = !0),
                    (this._startTime = +new Date()));
                  var e = this._lastTime || +new Date();
                  (this._lastTime = +new Date()),
                    this._lastTime - e > this.sessionInterval &&
                      (this._clearInterval(),
          ...
          var Monitor = (function() {
              ...
              return (
                (e.prototype.sdkOnload = function(e, t, i) {
                  if (!this.sdkReady) {
                    this.sdkReady = !0;
                    try {
          ...
          var storage = new Storage(!1),
            ...
            setVersionCache = function(e, t, i) {
              void 0 === i && (i = !1);
              var n = i
                ? { ab_ext_version: t, timestamp: Date.now() }
                : { ab_version: t, timestamp: Date.now() };
              _setCache(e, n);
            },
            setMultilinkCache = function(e, t) {
              var i = { ab_version_multilink: t, timestamp: Date.now() };
              _setCache(e, i);
            },
          ...
          function processMsg(e) {
            if (
              ...
              var i = t.type,
                n = t.payload;
              msgQueueMap[i] &&
                msgQueueMap[i].forEach(function(t) {
          ...
          function init(e, t) {
            delete e.filter,
              (window.opener || window.parent).postMessage(
                { type: "tea:sdk:info", config: e, version: t },
                "*"
              ),
          ...
          var loadMuiltlink = function(e, t, i, n) {
                  ...
                  if (i) {
                    ...
                    (window.TEAVisualEditor.__editor_ajax_domain = n || ""),
                      ...
                      loadEditorScript({
                        event: t,
                        editorUrl:
                          decodeUrl(VISUAL_URL_INSPECTOR) +
                          ".js?query=" +
                          Date.now(),
                        collectInstance: e
                      });
            ...
            VISUAL_RANGER_URL =
              decodeUrl(VISUAL_URL_RANGER) + "?query=" + Date.now(),
          ...
          var AB = (function() {
              function e(e, t, i) {
                ...
                var n = this.collector._initConfig,
                  ...
                  u = n.channel_domain,
                  h = n.enable_ab_visual,
                  d = n.ab_timeout;
                if (
                  ((this.appId = r),
                  (this.timeout = d || 3e3),
                  (this.domain = c || decodeUrl(DOMAINS[o || "cn"])),
                  this.domain)
                ) {
                  (this.needOverlay = s || h || !1),
                    (this.enable_ab_visual = h),
                    (this.enable_multilink = s),
                    (this.closeTime = a || 500),
                    (this.Hook = t);
                  var l = u || decodeUrl(LOG_URL[o]);
                  (this.reportUrl = "" + l + REPORT_URL),
                    this.editCheck(),
                    h &&
                    (readyToLoadEditor(e, this.appId, c || "", i),
                    "visual-editor" === this.editMode)
                      ? this.collector.destroy()
                      : (s && loadMuiltlink(e, this.appId, c || "", i),
                        this._check(),
                        this.wait());
                }
              }
              return (
                (e.prototype.editCheck = function() {
                  var e = getIframeUrl();
                  if (e) {
                    var t = e.scenario,
                      i = e.href;
                    t
                      ? "heatmap" === t
                        ? (this.editMode = "heatmap")
                        : "visual-editor" === t &&
                          (this.editMode = "visual-editor")
                      : !i ||
                        (-1 === i.indexOf("datatester") &&
                          -1 === i.indexOf("visual-editor")) ||
                        (this.editMode = "visual-editor");
                  }
                }),
                ...
                (e.prototype.refetch = function(e) {
                  ...
                  (t.user.user_unique_id =
                    e.user_unique_id || t.user.user_unique_id),
                    (t.user.ssid = e.ssid || t.user.ssid),
                    (t.user.web_id = e.web_id || t.user.web_id),
                    this.init(t);
                }),
                (e.prototype.init = function(e, t) {
                  if (!this.collector.destroyInstance && this.domain) {
                    this.config = e;
                    var i = e.user,
                      n = e.header,
                      r = __rest(n, []);
                    (this.user = __assign({}, i)),
                      ...
                      this._fetch(__assign({}, r), { success: t, fail: t });
                  }
                }),
                ...
                (e.prototype.wait = function() {
                  var e = this;
                  this.needOverlay &&
                    (this.isWait || (this.openOverlayer(), (this.isWait = !0)),
                    setTimeout(function() {
                      e.closeOverlayer();
                    }, this.closeTime));
                }),
                (e.prototype.getAllVars = function(e) {
                  ...
                  var t = { callback: e, type: CallbackType.All };
                ...
                (e.prototype._getVar = function(e, t) {
                  ...
                  if (o) {
                    if ("object" == typeof o[i] && void 0 !== o[i].val) {
                      ...
                      return (
                        "$ab_url" === t
                          ? (-1 === this.mulilinkVersions.indexOf(s) &&
                              this.mulilinkVersions.push(s),
                            this._updateMultilinkVersions())
                          : (-1 === this.versions.indexOf(s) &&
                ...
                (e.prototype._abEvent = function(e, t, i) {
                  ...
                  try {
                    if (e) {
                      ...
                      var c = { events: [r], user: a, header: s };
                      "$ab_url" === t
                        ? window.navigator.sendBeacon
                          ? window.navigator.sendBeacon(
                              this.reportUrl,
                ...
                (e.prototype._fetchComplete = function(e) {
                  ...
                  if (
                    ...
                    Object.keys(e).forEach(function(t) {
                      ...
                      -1 !== window.location.href.indexOf("multilink=true") ||
                    ...
                    if (r && r.val && this.enable_ab_visual) {
                      ...
                      o &&
                        s &&
                        this.getVar("$ab_url", o, function(e) {
                          if ("heatmap" !== t.editMode) {
                            var i = window.location.href;
                            -1 !== i.indexOf("multilink=true") &&
                              (i = t.filterUrl(i)),
                              o !== i
                                ? setTimeout(function() {
                  ...
                  this.callbacks.forEach(function(e) {
                    t[e.type === CallbackType.Var ? "_getVar" : "_getAllVars"](
                      e,
                      ""
                    );
                  }),
                ...
                (e.prototype._fetch = function(e, t) {
                  ...
                  var c = "" + this.domain + API,
                    ...
                    h = !1;
                  -1 !== u.indexOf("multilink=true") &&
                    ((u = this.filterUrl(u)), (h = !0));
                  ...
                  xhr(
                    c,
                    {
                      header: __assign(
                        ...
                        this.user || {},
                        e || {},
                        { ab_sdk_version: d.join(","), ab_url: u }
                      )
                    },
                    function(e) {
                      ...
                      var t = e.data;
                      "success" === e.message
                        ? (i._fetchComplete(t), o(t))
                        : (i._fetchComplete(null), a());
                    },
                    function() {
                      (i.fetchStatus = FetchStatus.Complete),
                        a(),
                        i._fetchComplete(null);
                    },
                    "",
                    this.timeout
                  );
                ...
                (e.prototype.filterUrl = function(e) {
                  try {
                    var t = "";
                    -1 !== e.indexOf("&multilink=true")
                      ? (t = "&multilink=true[\0-ÿ]*")
                      : -1 !== e.indexOf("?multilink=true") &&
                        (t = "\\?multilink=true[\0-ÿ]*");
            ...
            Et_Test = (function() {
              function e(e) {
                "string" == typeof e.event_verify_url &&
                  (this.url = e.event_verify_url + "/" + ET_TEST_URL);
              }
              return (
            ...
            Plugin = function(e, t, i, n, r) {
              t &&
                (t.enable_stay_duration && (this.stay = new StayDuration(n, t)),
            ...
            Profile = (function() {
              function e(e, t, i) {
                (this.processEvent = e),
                  ...
                  (this.profileReady = !1),
                  (this.reportUrl =
                    (i.channel_domain || decodeUrl(LOG_URL[i.channel])) +
                    "/profile/list");
              }
              return (
                ...
                (e.prototype.appendProfile = function(e) {
                  if (e) {
                    ...
                    for (var i in e)
                      ("string" != typeof e[i] &&
                        "Array" !==
                          Object.prototype.toString.call(e[i]).slice(8, -1)) ||
                        (t[i] = e[i]);
                    Object.keys(t).length &&
                      this.report(
                        "__profile_append",
                ...
                (e.prototype._pushCache = function(e) {
                  ...
                  Object.keys(e).forEach(function(i) {
                    t.cache[i] = { val: t._clone(e[i]), timestamp: Date.now() };
                  });
                }),
                  ...
                  try {
                    ...
                    for (var r in e)
                      ("string" != typeof e[r] &&
                        "number" != typeof e[r] &&
                        "Array" !==
                          Object.prototype.toString.call(e[r]).slice(8, -1)) ||
                        (n[r] = e[r]);
                    var o = Object.keys(n);
                    if (!o.length) return;
                    var s = Date.now();
                    return o
                      .filter(function(n) {
                        ...
                        return t
                          ...
                          : !(
                              r &&
                              i._compare(r.val, e[n]) &&
                              s - r.timestamp < i.duration
                            );
                      })
                      .reduce(function(e, t) {
                        return (e[t] = n[t]), e;
                ...
                var e = "millisecond",
                  ...
                  _ = {
                    ...
                    m: function e(t, i) {
                      ...
                      var n =
                          12 * (i.year() - t.year()) + (i.month() - t.month()),
                        r = t.clone().add(n, s),
                        o = i - r < 0,
                    ...
                    return (
                      ...
                      (p.add = function(e, a) {
                        ...
                        var d = b.p(a),
                          l = function(t) {
                            var i = z(h);
                            return b.w(i.date(i.date() + Math.round(t * e)), h);
                          };
            ...
            duration = createCommonjsModule(function(e, t) {
              var i, n, r, o, s, a, c, u, h, d, l, f, p, _, g;
              e.exports =
                  ...
                  return (
                    ...
                    (t.parseFromMilliseconds = function() {
                      ...
                      (this.$d.years = f(e / o)),
                        ...
                        (this.$d.months = f(e / s)),
                        (e %= s),
                        (this.$d.days = f(e / 864e5)),
                        (e %= 864e5),
                        (this.$d.hours = f(e / 36e5)),
                        (e %= 36e5),
                        (this.$d.minutes = f(e / 6e4)),
                        (e %= 6e4),
                        (this.$d.seconds = f(e / 1e3)),
                        (e %= 1e3),
                    ...
                    (t.format = function(e) {
                      ...
                      return t.replace(r, function(e, t) {
                        return t || String(i[e]);
                      });
                    }),
                    (t.as = function(e) {
                      return this.$ms / c[d(e)];
                    }),
                    (t.get = function(e) {
                      var t = this.$ms,
                        i = d(e);
                    ...
                    (t.add = function(e, t, i) {
                      var n;
                      return (
                        (n = t ? e * c[d(t)] : u(e) ? e.$ms : h(e, this).$ms),
                        h(this.$ms + n * (i ? -1 : 1), this)
                      );
                    }),
                ...
                function(e, t, r) {
                  ...
                  (t.prototype.add = function(e, t) {
                    return u(e) && (e = e.asMilliseconds()), o.bind(this)(e, t);
                  }),
                    (t.prototype.subtract = function(e, t) {
                      return (
                        u(e) && (e = e.asMilliseconds()), s.bind(this)(e, t)
                      );
                    });
                });
            });
          ...
          var ignoreList = [
            ...
            CepRule = (function() {
              ...
              return (
                (CepRule.prototype.init = function() {
                  var e = this,
                    t = !0,
                    i = 0,
                    n = 0,
                  ...
                  if (
                    ...
                    xhr(
                      ...
                      function(t) {
                        t && 0 === t.code
                          ? ((s.fetch_interval = t.fetch_interval),
                            (s.data = t.data),
                      ...
                      function() {
                        o
                          ? ((e.planData = s.data), e.initState(s.data))
                          : (e.support = !1);
                      }
                    );
                  } else
                ...
                (CepRule.prototype.check = function(e) {
                  ...
                  return !(
                    ...
                    t < 1e3 * e.start_time ||
                    t > 1e3 * e.end_time ||
                    ((this.staing = "testing" === e.staing),
                    SDK_VERSION < e.web_sdk_version && ((this.support = !1), 1))
                  );
                }),
                      ...
                      if (
                        ...
                        for (var s = r.pattern.events, a = 0; a < s.length; a++)
                          if (this.rule(e, t, i, s[a].condition)) {
                            ...
                            if (!u.isMatch) {
                              u.after && c.get(u.after).isMatch
                                ? this.changeStatus(o, s[a].id, i)
                                : u.after || this.changeStatus(o, s[a].id, i);
                              break;
                            }
                          }
                    }
                ...
                (CepRule.prototype.statusCheck = function() {
                  ...
                  try {
                    for (
                      var r = __values(this.stateArray), o = r.next();
                      !o.done;
                      o = r.next()
                    ) {
                        ...
                        for (
                          ...
                          if (p.after && (!p.after || u.get(p.after).isMatch)) {
                            if ("NOT_FOLLOWED_BY" === p.connection) {
                              p.isMatch
                                ? this.reset(a, f)
                                : Date.now() - u.get(p.after).matchTime >
                                  p.window
                                ? this.publish(
                                    [u.get(p.after).event, p.event],
                                    a,
                                    f
                                  )
                                : this.startWait(a, f, p);
                              break;
                            }
                            p.isMatch
                              ? p.matchTime - u.get(p.after).matchTime <=
                                p.window
                                ? this.publish(
                                    [u.get(p.after).event, p.event],
                                    a,
                                ...
                                : this.reset(a, f)
                              : Date.now() - u.get(p.after).matchTime > p.window
                              ? this.reset(a, f)
                              : this.startWait(a, f, p);
                            break;
                          }
                    ...
                    if (!r.get(t)) {
                      var o = setTimeout(function() {
                        ...
                        if ("NOT_FOLLOWED_BY" === o.connection)
                          (!o.isMatch && r.get(o.after).isMatch) ||
                          o.matchTime - r.get(o.after).matchTime > i.window
                            ? (((s = n.waitArray
                                .get(e)
                                .get(t)).triggerWait = !0),
                      ...
                      r.set(t, { waitFn: o, triggerWait: !1 }),
                      ...
                      return (function i(a) {
                        if (a && a.length) {
                          for (var c = !1, u = 0; u < a.length; u++) {
                            if (
                              -1 !== moreOP.indexOf(a[u].op) &&
                              a[u].hasOwnProperty("conditions")
                            )
                              return i(a[u].conditions);
                            var h = r.scope(a[u].key),
                              d = h.scope,
                              l = h.key,
                              f = h.key2,
                              p = d
                                ? "header" === d
                                  ...
                                  : s[l]
                                : o,
                              _ = r.calculate(a[u].op, p, a[u].value);
                            if ("or" !== n.op) {
                              if (!_) return !1;
                              c = _;
                            } else if (_) return !0;
                    ...
                    var a = this.scope(n.key),
                      ...
                      d = c
                        ? "header" === c
                          ...
                          : s[u]
                        : o;
                    return this.calculate(n.op, d, n.value);
                  } catch (e) {
                    return !1;
                  }
                }),
                ...
                (CepRule.prototype.addQuotas = function(e) {
                  ...
                  if (t && t.length) {
                    ...
                    i[e] || (i[e] = { value: 0, lastTime: Date.now() });
                    var n = i[e].value;
                ...
                (CepRule.prototype.event = function(e, t) {
                  try {
                    ...
                    var s = { events: [i], user: o, header: r };
          ...
          function getNodeText(e) {
            ...
            return (
              3 === e.nodeType
                ...
                : e.dataset && e.dataset.hasOwnProperty("teaTitle")
                ? (t = e.getAttribute("data-tea-title"))
                : e.hasAttribute("ata-tea-title")
                ? (t = e.getAttribute("data-tea-title"))
                : e.hasAttribute("title")
                ? (t = e.getAttribute("title"))
                : "INPUT" === e.nodeName &&
                  ["button", "submit"].includes(e.getAttribute("type"))
          ...
          function isTrack(e, t) {
            if ((window.innerHeight, window.innerWidth, 1 !== e.nodeType))
              return !1;
            ...
            return !(
              ...
              (!isNeedElement(i, "container") && !elementLevel(i))
            );
          }
          var Listener = (function() {
              function e(e, t, i) {
                ...
                (this.clickEvent = function(e) {
                  isTrack(e.target, n.options) &&
                    n.eventHandel({ eventType: "dom", eventName: "click" }, e);
                }),
                  ...
                  (this.getPageViewEvent = function(e, t) {
                    t &&
                      "pushState" === t &&
                      n.eventHandel(
                        { eventType: "dom", eventName: "beat" },
                        __assign({ beat_type: 0 }, e)
                      ),
                      n.eventHandel(
                        { eventType: "dom", eventName: "page_view" },
                        e
                      );
                  }),
                  (this.getPageLoadEvent = function(e) {
                    n.eventHandel(
                      { eventType: "dom", eventName: "page_statistics" },
                      { lcp: e }
                    );
                  }),
              ...
              return (
                ...
                (e.prototype.addListener = function(e) {
                  ...
                  if (
                    ...
                    this.config.pv &&
                      this.route.init("autotrack", this.getPageViewEvent),
                    this.config.beat)
                  ) {
                    try {
                    ...
                    try {
                      ...
                      o && o.length
                        ? (new PerformanceObserver(function(e) {
                            ...
                            t.statistics ||
                              (t.getPageLoadEvent(r), (t.statistics = !0));
                          }).observe({
                            entryTypes: ["largest-contentful-paint"]
                          }),
                          setTimeout(function() {
                            t.statistics ||
                              (t.getPageLoadEvent(o[0].startTime || 0),
                              (t.statistics = !0));
                          }, 2e3))
          ...
          function getEventData(e, t) {
            ...
            var i = e.clientX,
              ...
              s = i - r >= 0 ? i - r : 0,
              a = n - o >= 0 ? n - o : 0;
            return { touch_x: Math.floor(s), touch_y: Math.floor(a) };
          }
          function getXpath(e) {
            ...
            return (
              ...
              { element_path: "/" + i.join("/"), positions: n }
            );
          }
          function getXpathIndex(e) {
            ...
            return {
              str: [
                ...
                isNeedElement(e, "list") ? "[]" : ""
              ].join(""),
              index: t
            };
          }
          function getElementData(e, t, i) {
            var n = { element_path: "", positions: [], texts: [] },
              r = getPositionData(t),
              o = getEventData(e, r),
              s = r.element_width,
              a = r.element_height,
              ...
              m = null;
            window.TEAVisualEditor.getOriginXpath &&
              (m = window.TEAVisualEditor.getOriginXpath({
                xpath: d,
                positions: g
              })),
              (n.element_path = (m && m.xpath) || d),
              (n.positions = (m && m.positions) || g),
              i &&
                !i.text &&
                ((n.texts = f), (n.element_title = getTextSingle(t))),
              (n.element_width = Math.floor(s)),
              (n.element_height = Math.floor(a)),
              (n.touch_x = c),
              (n.touch_y = u),
              (n.page_manual_key = ""),
              (n.elememt_manual_key = ""),
              (n.since_page_start_ms = _),
              (n.page_start_ms = p);
            var v = getContainer(t);
            return (
              "A" === v.tagName && (n.href = v.getAttribute("href")),
              "IMG" === t.tagName && (n.src = t.getAttribute("src")),
              n
            );
          }
          function getEventData$1(e, t, i, n) {
            return __assign({ event: e }, getElementData(t, i, n), {
              is_html: 1,
                  ...
                  try {
                    ...
                    switch (t) {
                      ...
                      case "change":
                        return __assign(
                          {},
                          getEventData$1((i = "bav2b_change"), e, e.target),
                          getExtraEventData(i, e.target)
                        );
                      case "submit":
                        return getEventData$1(
                          (i = "bav2b_submit"),
                  ...
                  try {
                    ...
                    if (t) {
                      ...
                      (e.refer_page_duration_ms = ""),
                        (e.refer_page_title = "");
                    (e.scroll_width = document.documentElement.scrollLeft
                      ? document.documentElement.scrollLeft + window.innerWidth
                      : window.innerWidth),
                      (e.scroll_height = document.documentElement.scrollTop
                        ? document.documentElement.scrollTop +
                          window.innerHeight
                        : window.innerHeight),
                      (e.page_start_ms =
            ...
            Request = (function() {
              ...
              return (
                (e.prototype.send = function(e, t) {
                  ...
                  delete t.event,
                    i && "becon" === i
                      ? this.logFuncBecon(n, t, "autotrack")
                      : this.logFunc(n, t, "autotrack");
                }),
          ...
          function setSession() {
            try {
              var e = (window.TEAVisualEditor.lang =
                  window.TEAVisualEditor.lang || js_cookie.get(COOKIE_LANG)),
                t = (window.TEAVisualEditor.__editor_ajax_domain =
                  window.TEAVisualEditor.__editor_ajax_domain ||
                  js_cookie.get(COOKIE_KEY_HOST)),
                i = (window.TEAVisualEditor.__editor_verison =
                  window.TEAVisualEditor.__editor_verison ||
                  js_cookie.get(COOKIE_EDIT_VERISON)),
                n = (window.TEAVisualEditor.__editor_url =
                  window.TEAVisualEditor.__editor_url ||
                  js_cookie.get(COOKIE_EDIT_URL)),
                r = +new Date(),
                o = new Date(r + 18e5);
              js_cookie.set(COOKIE_KEY, "1", { expires: o }),
                js_cookie.set(COOKIE_KEY_HOST, t, { expires: o }),
                js_cookie.set(COOKIE_EDIT_URL, n, { expires: o }),
                js_cookie.set(COOKIE_LANG, e, { expires: o }),
                js_cookie.set(COOKIE_EDIT_VERISON, i || "", { expires: o });
            } catch (e) {}
          }
          window.TEAVisualEditor = window.TEAVisualEditor || {};
          var EDITOR_URL = "",
            EDITOR_URL_OLD =
              window.TEAVisualEditor.__editor_url ||
              decodeUrl(EDITOR_URL_OLD_ASC);
          EDITOR_URL_OLD = EDITOR_URL_OLD + "?query=" + Date.now();
          var EDITOR_URL_NEW =
              decodeUrl(EDITOR_URL_NEW_ASC) + "?query=" + Date.now(),
            isLoaded$1 = !1;
              ...
              try {
                receiveMsg("tea:openVisualEditor", function(t) {
                  ...
                  if (r) {
                    ...
                    if (
                      (o
                        ? ((window.TEAVisualEditor.__editor_ajax_domain = o),
                          (EDITOR_URL = EDITOR_URL_NEW))
                        : (EDITOR_URL = EDITOR_URL_OLD),
                      i)
                    ) {
                      var a = r.version;
                      (EDITOR_URL = n
          ...
          var defaultOpt = { hashTag: !1, impr: !1 },
            AutoTrack = (function() {
              function e() {
              ...
              return (
                (e.prototype.start = function(e, t, i, n) {
                  (t = Object.assign(defaultOpt, t)),
                    (this.destroyed = !1),
                    (this.options = t),
                    (this.logFunc = e),
                    (this.logFuncBecon = i),
                    (this.Config = new Config(defaultConfig)),
                    (this.Listener = new Listener(t, this.Config, n)),
                    (this.EventHandle = new EventHandle(t)),
                ...
                (e.prototype.handleDom = function(e, t) {
                  try {
                    ...
                    if ("click" === i || "change" === i || "submit" === i) {
                      ...
                      (r =
                        "page_view" === i
                          ? this.EventHandle.handleViewEvent(t)
                          : this.EventHandle.handleStatisticsEvent(t)),
                        this.Request.send(
                          {
                            eventType: "custom",
            ...
            exportAutoTrack = function(e, t, i, n) {
              ...
              if (o) {
                ...
                "object" == typeof o && (s = o),
                  r.start(t, s, i, n),
                  readyToLoadEditor$1(r, e);
              } else r.autoTrackStart && r.destroy();
              return null;
            },
            exportMethods = [
              "profileSet",
              ...
              "getVar",
              "getAbSdkVersion",
              "onAbSdkVersionChange",
              "offAbSdkVersionChange",
              "getABconfig",
              "openOverlayer",
              "closeOverlayer",
              "getAllVars",
            ...
            getIndex =
              ((lastEventId =
                +Date.now() + Number(("" + Math.random()).slice(2, 8))),
              function() {
            ...
            Collector = (function() {
                ...
                (this.is_first_time = !1),
                  ...
                  (this.getToken = function(e, i) {
                    if (!t.sdkload)
                      return (
                        t.logger.warn(
                          "sdk init error, api can not call, getToken will return {}"
                        ),
                        void e({})
                      );
                    var n = !1,
                    ...
                    i &&
                      ...
                      t._token.isTokenReady()
                        ? r()
                        : (t.hook.on("get-token", function() {
                            r();
                          }),
                          (t._getToken = !0));
                  }),
              ...
              return (
                ...
                (e.prototype.init = function(e) {
                  ...
                  if (
                    !this._inited &&
                    ((this._inited = !0), e && "object" == typeof e)
                  ) {
                    ...
                    n || i
                      ? i && "number" != typeof i
                        ...
                        : (e.channel_domain ||
                            -1 !== ["cn", "sg", "va"].indexOf(e.channel) ||
                            (this.logger.warn(
                              "channel must be cn or sg or va!!!, use default channel cn"
                            ),
                            (e.channel = "cn")),
                          (this.Native = e.Native),
                          (this._initConfig = e),
                          (this.appBridge = new AppBridge(this.logger)),
                          this.storage.getItem("__tea_cache_first_" + i)
                            ? (this.is_first_time = !1)
                            : ((this.is_first_time = !0),
                              this.storage.setItem(
                                "__tea_cache_first_" + i,
                                "1"
                              )),
                          (this.sdkload = !0),
                          e.Native && this.appBridge.bridgeInject()
                ...
                (e.prototype._init = function(e) {
                  ...
                  (this.autoPV = !0),
                    ...
                    (this.plugin = new Plugin(
                      ...
                      this.beconEvent.bind(this),
                      this.hook
                    )),
                    e.cep &&
                      (this.match = new CepRule(e, this._config, this.hook)),
                ...
                (e.prototype.config = function(e) {
                  var t = this;
                  this.sdkload
                    ? this.Native && this.appBridge.bridgeInject()
                      ? this.appBridge.hasStarted(function(i) {
                          if (i)
                            for (var n in e)
                              "user_unique_id" === n
                                ? t.appBridge.setUserUniqueId(e[n])
                                : e[n]
                                ? t.appBridge.addHeaderInfo(n, e[n])
                                : t.appBridge.removeHeaderInfo(n);
                          else t._setConfig(e);
                        })
                      : this._setConfig(e)
                ...
                (e.prototype._setConfig = function(e) {
                  if (this._inited)
                    if (e && "object" == typeof e) {
                      e.disable_auto_pv &&
                        ((this.autoPV = !1), delete e.disable_auto_pv),
                        e._staging_flag &&
                          1 === e._staging_flag &&
                          (this.staging = !0);
                      var t = __assign({}, e);
                      ...
                      for (var n in t)
                        "user_unique_id" !== n
                          ? "web_id" !== n
                            ? this._config.set(n, t[n])
                            : this._token._setWebid(t[n])
                          : this._token._setUuid(t[n]);
                    } else
                  ...
                  this.sdkload
                    ? this.Native && this.appBridge.bridgeInject()
                      ? this.appBridge.hasStarted(function(t) {
                          t
                            ? (e.logger.info("jsbrige open, to native"),
                              e.predefinePageView())
                            : e._start();
                        })
                      : this._start()
                ...
                (e.prototype._start = function() {
                  ...
                  if (this._token.isTokenReady()) {
                    ...
                    (this.profile = new Profile(
                      ...
                      this.plugin &&
                        this.plugin.ab &&
                        this.plugin.ab.init(this._config.get());
                ...
                (e.prototype.event = function() {
                  ...
                  if (this.sdkload) {
                    var n = __read(t, 1)[0],
                      r = [];
                    "Array" !== Object.prototype.toString.call(n).slice(8, -1)
                      ? (r[0] = t)
                      : (r = t),
                      (r = r.map(function(t) {
                ...
                (e.prototype._commonEvent = function(e, t) {
                  e ? this._event.beconEvent(t) : this._event.event(t),
                    ...
                    this.plugin &&
                      this.plugin.session &&
                      this.plugin.session.process();
                }),
                (e.prototype._addTracerCount = function(e) {
                  this.sdkload
                    ? this.Native || this.staging || this.tracer.addCount(e)
                    : this.logger.warn("sdk init error, api can not call");
                }),
                (e.prototype._processEvent = function(e, t) {
                  try {
                    ...
                    return (
                      ...
                      r.profile
                        ? delete r.profile
                        : (r.event_index = getIndex()),
                      r.local_ms
                        ? ((n = r.local_ms), delete r.local_ms)
                        : (n = +new Date()),
                      {
                        event: i,
                        params: r,
                ...
                (e.prototype.resetStayDuration = function(e, t, i) {
                  this.sdkload
                    ? this.plugin.stay
                      ? this.plugin.stay && this.plugin.stay.reset(e, t, i)
                      : this.logger.info("stayDuration is not init")
                    : this.logger.warn("sdk init error, api can not call");
                }),
                (e.prototype.profileSet = function(e) {
                  ...
                  this.sdkload
                    ? this.Native && this.appBridge.bridgeInject()
                      ? this.appBridge.hasStarted(function(i) {
                          i
                            ? t.appBridge.profileSet(JSON.stringify(e))
                            : t.profile && t.profile.setProfile(e);
                        })
                      : this.profile && this.profile.setProfile(e)
                    : this.logger.warn("sdk init error, api can not call");
                }),
                (e.prototype.profileSetOnce = function(e) {
                  ...
                  this.sdkload
                    ? this.Native && this.appBridge.bridgeInject()
                      ? this.appBridge.hasStarted(function(i) {
                          i
                            ? t.appBridge.profileSetOnce(JSON.stringify(e))
                            : t.profile && t.profile.setOnceProfile(e);
                        })
                      : this.profile && this.profile.setOnceProfile(e)
                    : this.logger.warn("sdk init error, api can not call");
                }),
                (e.prototype.profileIncrement = function(e) {
                  ...
                  this.sdkload
                    ? this.Native && this.appBridge.bridgeInject()
                      ? this.appBridge.hasStarted(function(i) {
                          i
                            ? t.appBridge.profileIncrement(JSON.stringify(e))
                            : t.profile && t.profile.incrementProfile(e);
                        })
                      : this.profile && this.profile.incrementProfile(e)
                    : this.logger.warn("sdk init error, api can not call");
                }),
                (e.prototype.profileUnset = function(e) {
                  ...
                  this.sdkload
                    ? this.Native && this.appBridge.bridgeInject()
                      ? this.appBridge.hasStarted(function(i) {
                          i
                            ? t.appBridge.profileUnset(e)
                            : t.profile && t.profile.unsetProfile(e);
                        })
                      : this.profile && this.profile.unsetProfile(e)
                    : this.logger.warn("sdk init error, api can not call");
                }),
                (e.prototype.profileAppend = function(e) {
                  ...
                  this.sdkload
                    ? this.Native && this.appBridge.bridgeInject()
                      ? this.appBridge.hasStarted(function(i) {
                          i
                            ? t.appBridge.profileAppend(JSON.stringify(e))
                            : t.profile && t.profile.appendProfile(e);
                        })
                      : this.profile && this.profile.appendProfile(e)
                    : this.logger.warn("sdk init error, api can not call");
                }),
                (e.prototype.setExternalAbVersion = function(e) {
                  this.sdkload
                    ? e && this.plugin.ab && this.plugin.ab._setAbVersion(e)
                    : this.logger.warn("sdk init error, api can not call");
                }),
                (e.prototype.getVar = function(e, t, i) {
                  var n = this;
                  if (!this.sdkload)
                    return (
                      this.logger.warn(
                        "sdk init error, api can not call, getVar return default value"
                      ),
                      void i(t)
                    );
                  this.hook.on("token-error", function() {
                    n.logger.warn(
                      "sdk init error, getVar return default value"
                    ),
                      i(t);
                  }),
                ...
                (e.prototype.getABconfig = function(e, t) {
                  if (!this.sdkload)
                    return (
                      this.logger.warn(
                        "sdk init error, api can not call, getABconfig return null"
                      ),
                      void t(null)
                    );
                ...
                (e.prototype.getAbSdkVersion = function(e) {
                  if (!this.sdkload)
                    return (
                      this.logger.warn(
                        "sdk init error, api can not call, getAbSdkVersion return null"
                      ),
                      void e(null)
                    );
                ...
                (e.prototype.onAbSdkVersionChange = function(e) {
                  this.sdkload
                    ? this.hook.on("onAbSdkVersionChange", e)
                    : this.logger.warn("sdk init error, api can not call");
                }),
                (e.prototype.offAbSdkVersionChange = function(e) {
                  this.sdkload
                    ? e
                      ? this.hook.off("onAbSdkVersionChange", e)
                      : this.hook.off("onAbSdkVersionChange")
                    : this.logger.warn("sdk init error, api can not call");
                }),
                (e.prototype.openOverlayer = function() {
                  this.sdkload
                    ? this.plugin.ab && this.plugin.ab.openOverlayer()
                    : this.logger.warn("sdk init error, api can not call");
                }),
                (e.prototype.closeOverlayer = function() {
                  this.sdkload
                    ? this.plugin.ab && this.plugin.ab.closeOverlayer()
                    : this.logger.warn("sdk init error, api can not call");
                }),
                (e.prototype.getAllVars = function(e) {
                  var t = this;
                  if (!this.sdkload)
                    return (
                      this.logger.warn(
                        "sdk init error, api can not call, getAllVars return null"
                      ),
                      void e(null)
                    );
                  this.hook.on("token-error", function() {
                ...
                (e.prototype.destroy = function() {
                  this.destroyInstance ||
                    ((this.destroyInstance = !0), this.hook.off("token-ready"));
                }),
                e
              );
            })();
          ...
          var CollectAsync = function(e) {
              var t = this;
              return (
                _defineProperty(this, "_exportCollect", function() {
                  for (
                    ...
                    i[n] = arguments[n];
                  t._isProcess
                    ? t._executeCmd.apply(t, i)
                    : (t.cmdQueue.push(i), t._processCmd());
                }),
                ...
                _defineProperty(this, "_executeCmd", function() {
                  ...
                  var r,
                    ...
                    s = i[0];
                  Methods.indexOf(s) > -1
                    ? (r = t.colloctor)[s].apply(r, i.slice(1))
                    : (o = t.colloctor).event.apply(o, i);
                }),
                (this.cmdQueue = []),
                (this.name = e),
            ...
            processCmdArray = function(e) {
              try {
                ...
                if (1 === r.length)
                  ...
                  "event" === r[0]
                    ? getCmdArray("default").push(__spread([i], n))
                    : getCmdArray(r[0]).push(__spread([r[1]], n));
                else {
                  var o = r[0],
                    s = [r[1], r[2]].join(".");
            ...
            processCmd = function() {
              defaultClient.q.forEach(function(e) {
                var t = [].slice.call(e);
                "Array" === Object.prototype.toString.call(t[0]).slice(8, -1)
                  ? t.forEach(function(e) {
                      processCmdArray(e);
                    })
                  : processCmdArray(t);
