 ...
 */ !(function(
  ...
  function(t, e, n) {
    ...
    let i = /\s+/g,
      ...
      l = /(のは|例えば|しかし|そして|けれども|ところが|けども|けど|だが|から(?![\d|は]))/g,
      f = /(なければならないんだ[ろうな|ろう|よ|か|が|ね]|なければならないんだ|でしょう|ましょう|ありません[よ|か|が|ね]|ありません|あります[よ|か|が|ね]|あります|できます[よ|か|が|ね]|できます|なりません[よ|か|が|ね]|なりません|なります[よ|か|が|ね]|なります|ます[よ|か|が|ね]|ます|ません[よ|か|が|ね]|ません|です[ね|が]|ですか(?!ら)|です(?!から)|でした[ね|か|が]|でした|だけで|ました[ら|ろうな|ろう|よ|か|が|ね]|ました)(?!(けれども|けども|けど|だが)、)/g,
      ...
      return (
        ...
        (function(t, e) {
          ...
          for (let t = 0; t < n.length; t++)
            "か" == e[(o = n[t].index + n[t][0].length) - 1]
              ? (i += e.substring(r, o) + "？")
              : (i += e.substring(r, o) + "。"),
              (r = o);
