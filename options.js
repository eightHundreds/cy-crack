  ...
  function(t, e, n) {
    ...
    function A(t) {
      Object(r.g)(
        t,
        "svelte-edix8z",
        '@charset "UTF-8";.container{font-family:"PingFang SC", "Helvetica Neue", "Helvetica", "Arial", "Microsoft YaHei", "微软雅黑", "STXihei", "华文细黑", " sans-serif"}.logo-version{display:flex;flex-direction:column;align-items:center;padding:25px 0 30px;color:#333;font-size:16px;font-weight:400;text-align:center}.logo-version>img{margin-bottom:20px}.collection{font-size:1.14rem;margin-bottom:2rem;border:none;border-radius:10px;box-shadow:0 0 20px 0 rgba(0, 0, 0, 0.1)}.collection .collection-item{position:relative;display:flex;padding:19px 20px 18px;justify-content:space-between;align-items:center;border-bottom:1px solid transparent;color:#333}.collection .collection-item::after{content:"";position:absolute;bottom:0;left:20px;right:20px;margin:auto;height:1px;background:#f5f5f5}.collection .collection-item:last-child::after{display:none}.collection .collection-item .secondary-content{color:#00b977;float:none}.collection a.collection-item{color:#00b977}.collection a.collection-item:not(.active):hover{background-color:transparent}'
      );
    }
    function z(t) {
      let e, n, o;
